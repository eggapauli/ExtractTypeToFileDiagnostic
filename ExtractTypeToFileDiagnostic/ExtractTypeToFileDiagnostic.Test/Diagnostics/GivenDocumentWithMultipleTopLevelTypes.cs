...
{
    [TestFixture]
    public class GivenDocumentWithMultipleTopLevelTypes : DiagnosticTest
    {
...
namespace TestNamespace
{
    ...
    class TypeB { }
        ...
        public async Task ShouldCreateDiagnosticWithCorrectLocation()
        {
            ...
            var expectedSpan = new FileLinePositionSpan("TypeA.cs", new LinePosition(6, 10), new LinePosition(6, 15));
